...
class Passenger:
    ...
    def __init__(self, root):
        ...
        def addData():
            if (len(Pno.get()) != 0):
                sqlite3.addPas(Pno.get(), Pname.get(), PAddress.get(), Pmobile.get(), Bno.get(), Rname.get())
                passengerList.delete(0, END)
                passengerList.insert(END,
                                     (Pno.get(), Pname.get(), PAddress.get(), Pmobile.get(), Bno.get(), Rname.get()))

        def displayData():
            passengerList.delete(0, END)
            for row in sqlite3.viewDat():
        ...
        def deleteData():
            if (len(Pno.get()) != 0):
                sqlite3.deleteDat(sd[0])
                clearData()
                displayData()

        def searchData():
            passengerList.delete(0, END)
            for row in sqlite3.searchDat(Pno.get(), Pname.get(), PAddress.get(), Pmobile.get(), Bno.get(),
                                             Rname.get()):
                passengerList.insert(END, row, str(""))
        ...
        DataFrameLEFT = LabelFrame(DataFrame, bd=1, width=600, height=1000, padx=20, pady=73, bg='Ghost White',
                                   relief=RIDGE,
        ...
        self.lblPno = Label(DataFrameLEFT, font=('arial', 20, 'bold'), text="Passenger Number : ", padx=2, pady=2,
                            bg="Ghost White")
        ...
        self.lblPname = Label(DataFrameLEFT, font=('arial', 20, 'bold'), text="Passenger Name : ", padx=2, pady=2,
                              bg="Ghost White")
        ...
        self.lblPAddress = Label(DataFrameLEFT, font=('arial', 20, 'bold'), text="Passenger Address : ", padx=2, pady=2,
                                 bg="Ghost White")
        ...
        self.lblPMobile = Label(DataFrameLEFT, font=('arial', 20, 'bold'), text="Passenger Mobile : ", padx=2, pady=2,
                                bg="Ghost White")
        ...
        self.lblBno = Label(DataFrameLEFT, font=('arial', 20, 'bold'), text="Bus Number : ", padx=2, pady=2,
                            bg="Ghost White")
        ...
        self.lblRname = Label(DataFrameLEFT, font=('arial', 20, 'bold'), text="Route Name : ", padx=2, pady=2,
                              bg="Ghost White")
        ...
        passengerList = Listbox(DataFrameRIGHT, width=41, height=16, font=('arial', 12, 'bold'),
        ...
        self.btnDisplayDate = Button(ButtonFrame, text="Display", font=('arial', 20, 'bold'), height=1, width=10, bd=4,
                                     command=displayData)
        self.btnDisplayDate.grid(row=0, column=1)

        self.btnClearDate = Button(ButtonFrame, text="Clear", font=('arial', 20, 'bold'), height=1, width=10, bd=4,
                                   command=clearData)
        self.btnClearDate.grid(row=0, column=2)

        self.btnDeleteDate = Button(ButtonFrame, text="Delete", font=('arial', 20, 'bold'), height=1, width=10, bd=4,
                                    command=deleteData)
        self.btnDeleteDate.grid(row=0, column=3)

        self.btnSearchDate = Button(ButtonFrame, text="Search", font=('arial', 20, 'bold'), height=1, width=10, bd=4,
                                    command=searchData)
        self.btnSearchDate.grid(row=0, column=4)

        self.btnUpdateDate = Button(ButtonFrame, text="Update", font=('arial', 20, 'bold'), height=1, width=10, bd=4,
                                    command=update)
